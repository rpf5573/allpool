...
class Upload extends Field {
	...
	private function upload( $file ) {
		...
		if ( $file_size > ap_opt( 'max_upload_size' ) ) {
			return new \WP_Error( 'upload_file_size', __( 'File is bigger then the allowed limit.', 'anspress-question-answer' ) );
		}
		...
		if ( false === $move_new_file ) {
			return new \WP_Error( 'upload_file_move', __( 'The uploaded file could not be moved', 'anspress-question-answer' ) );
		}
