...
// Process submit form. 아니 이걸 왜 여기서 하냐?
									...
									<div class="postbox">
										...
										<div class="inside">
											...
											if ( isset( $args['template'] ) ) {
												include ANSPRESS_DIR . 'includes/admin/views/' . $args['template'];
											} else {
                        $the_name = 'options_' . $active_tab . '_' . $groupkey;
								...
								<div class="postbox">
									...
									<div class="inside">
										...
										if ( isset( $active_option['template'] ) ) {
											include ANSPRESS_DIR . 'includes/admin/views/' . $active_option['template'];
										} else {
